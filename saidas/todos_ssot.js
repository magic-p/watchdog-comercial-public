window.WATCHDOG_TODOS = [
  ...
  {
    "id": "t034",
    "task": "Alinhar e executar ação Instagram com comercial",
    "comment": "Pedido da Lili. Karina alinha com o time comercial a ação de Instagram e executa hoje. Definir: base alvo, copy, segmentação e horário de execução.",
    "owner": "Kaka",
    "date": "26/fev",
    "tier": "t1",
    "tierLabel": "A fazer",
  ...
  {
    "id": "t035",
    "task": "Ajustes CRM: casos duplicados e escolas que não querem contato (pedido Lua)",
    "comment": "Pedido da Lili, originado por Lua. Dois tipos de ajuste: (1) registros duplicados no CRM — limpar para evitar abordagem dupla e inflação de métricas (alinhado com alerta017 — duplicatas na base AA); (2) escolas que sinalizaram não querer mais contato — atualizar flag no CRM para não aparecerem em futuras campanhas e disparos. Resultado: base mais limpa e métricas mais confiáveis.",
    "owner": "Vitoria",
    "date": "26/fev",
    "tier": "t2",
    "tierLabel": "Fazendo",
